...
namespace VisualizzatoreWPF.ViewModels
{
    public class LoginModel : BaseViewModel
    {
        ...
        public event EventHandler<SecureString> PasswordChanged;
        ...
        public LoginModel()
        {
            ...
            PasswordChanged += LoginModel_PasswordChanged;

        }

        private void LoginModel_PasswordChanged(object sender, SecureString e)
        {
        ...
        private async void LoginAsync()
        {
            ...
            string token = await tokenService.GetToken(Username, Password.ToString());
